...
public class Spline1Path extends SequentialCommandGroup {
  public Spline1Path(DriveSubsystem swerveDrive) {
    PathPlannerTrajectory trajectory = PathPlanner.loadPath("Spline-1", 3,
        3, false);
